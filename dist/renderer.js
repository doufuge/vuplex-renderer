...
/** invoke 默认超时时间（毫秒） */
export const DEFAULT_INVOKE_TIMEOUT = 30000;
/**
 * Web 侧 IPC 通信层
 *
...
export class RendererIPC {
     ...
     */
    invoke(channel, data, timeout = DEFAULT_INVOKE_TIMEOUT) {
        ...
        return new Promise((resolve, reject) => {
            const timer = setTimeout(() => {
                ...
                reject(new Error(`IPC invoke timeout: channel="${channel}" (${timeout}ms)`));
            }, timeout);
            this.pending.set(id, {
                resolve,
                reject,
